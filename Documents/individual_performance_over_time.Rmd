...
```{r eval=TRUE, echo=FALSE, fig.height=4, fig.width=7, tidy=FALSE, message=FALSE, warning=FALSE}
  ...
  plot_volume(perf_4h_south_clean, prov_codes = pr, start.date = "2014-02-01",end.date = "2017-02-01", all_provs = all_provs)
  ...
  plot_volume(perf_4h_south_clean, prov_codes = pr, start.date = "2014-02-01",end.date = "2017-02-01", adm_only = TRUE, min_upper_y_scale = 750, all_provs = all_provs)
