...
cht.end.date <- "2017-05-01"
cht.brk.date <- "2016-02-01"

classification.start.date <- "2017-01-01"
classification.end.date <- "2017-06-30"
...
```{r, fig.height=5, fig.width=7, echo=FALSE, results='asis', cache=TRUE}
